    ...
    <nav class="sidebar">
        ...
        <ul id="sidebar_menu">
            {{-- <li class>
                ...
                <ul>
                    <li><a href="index-2.html">Tổng quan</a></li>
                    <li><a class="has-arrow" href="index_2.html">Biểu đồ thống kê</a></li>
                </ul>
            </li> --}}
            <li class="mm-active">
                <a class="active" href="{{ route('category.index') }}" aria-expanded="false">
            ...
            {{-- <li class>
                ...
                <ul>
                    <li><a href="accordion.html">Danh sách vé bán</a></li>
                    <li><a href="Scrollable.html">Tìm kiếm và lọc vé</a></li>
                </ul>
            </li> --}}
            <li class>
                <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <ul>
                    <li><a href="buttons.html">Danh sách khách hàng</a></li>
                    <li><a href="dropdown.html">Thêm/Sửa/Xóa khách hàng</a></li>
                    <li><a href="Badges.html">Quản lý admin</a></li>
                </ul>
            </li>
            <li class>
                <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <ul>
                    <li><a href="wow_animation.html">Doanh thu</a></li>
                    <li><a href="Scroll_Reveal.html">Chi phí</a></li>
                    <li><a href="tilt.html">Báo cáo tài chính</a></li>
                </ul>
            </li>
            <li class>
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="{{ asset('assets/admin/img/menu-icon/7.svg') }}" alt>
                    <span>Quản lý Đánh giá và Phản hồi</span>
                </a>
                <ul>
                    <li><a href="basic_card.html">Đánh giá từ khách hàng</a></li>
                    <li><a href="theme_card.html">Phản hồi</a></li>
                </ul>
            </li>
            <li class>
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="{{ asset('assets/admin/img/menu-icon/8.svg') }}" alt>
                    <span>Quản lý Khuyến mãi và Mã giảm giá</span>
                </a>
                <ul>
                    <li><a href="data_table.html">Danh sách mã giảm giá</a></li>
                    <li><a href="bootstrap_table.html">Thêm/Sửa/Xóa mã giảm giá</a></li>
                </ul>
            </li>
            {{-- <li class>
<a class="has-arrow" href="#" aria-expanded="false">
...
<li class>
<a class="has-arrow" href="#" aria-expanded="false">
<img src="{{ asset('assets/admin/img/menu-icon/map.svg') }}" alt>
<span>Maps</span>
</a>
<ul>
...
<li><a href="vector_map.html">Vector Maps</a></li>
    ...
    <section class="main_content dashboard_part">
                            ...
                            <div class="header_notification_warp d-flex align-items-center">
                                ...
                                <li>
                                    <a class="CHATBOX_open" href="#"> <img
                                            src="{{ asset('assets/admin/img/icon/msg.svg') }}" alt> <span>01</span>
                                    </a>
                                </li>
                            </div>
        ...
        <script src="{{ asset('assets/admin/vendors/apex_chart/apex_realestate.js') }}"></script>
