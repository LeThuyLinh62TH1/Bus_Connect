                            ...
                            <table class="table lms_table_active">
                                ...
                                <tbody>
                                    @forelse($categories as $item)
                                        <tr>
                                            {{-- <td>
                                                <img src="{{ asset($item->image) }}" alt="Ảnh tuyến xe" width="100"> <!-- Hiển thị hình ảnh -->
                                            </td> --}}
                                            <th scope="row"><a href="#"
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form action="{{ route('category.forceDelete', $item->id) }}"
                                                        method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-sm"
                                                            onclick="return confirm('Bạn có chắc chắn muốn xóa tuyến xe này không?')">
