                                        ...
                                        <ul class="nav toolber-tab-menu justify-content-start" role="tablist">
                                            <li class="tab__item nav-item active">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#tab_columns_01" role="tab">
                                                    <img src="{{ asset('assets/user/images/svg/column-03.svg') }}" class="img-fluid" alt="Columns 03">
                                                </a>
                                            </li>
                                            <li class="tab__item nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#tab_columns_02" role="tab"><img src="assets/user/images/svg/column-04.svg" class="img-fluid" alt="Columns 03"> </a>
                                            </li>
                                            <li class="tab__item nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#tab_columns_03" role="tab"><img src="assets/user/images/svg/column-05.svg" class="img-fluid" alt="Columns 03"> </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_1-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_2-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_3-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_4-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_5-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_6-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_7-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="{{ asset('assets/user/images/product/1_8-300x300.webp') }}" class="img-fluid" alt="Product Images" width="300" height="300">
